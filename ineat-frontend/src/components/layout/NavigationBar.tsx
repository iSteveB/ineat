...
export const NavigationBar: FC = () => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 ${bgColor} z-50 lg:max-w-2/3 xl:max-w-1/2 lg:m-auto`}>
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-col items-center">
          <button
            onClick={() => navigate({ to: '/app/inventory/add-product' })}
        ...
        <NavigationItem
          ...
          to="/app/settings"
          label="Paramètre"
          isActive={pathname.startsWith('/app/profile/settings') || pathname.startsWith('/app/settings')}
        />
      </div>
    </div>
  );
